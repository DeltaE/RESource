...
class OEDBTurbines:
    ...
    def fetch_turbine_config(self,
        ...
        self.turbine_config_file = Path('data/downloaded_data') / "OEDB"/ f"{self.turbine_name}.yaml"
        ...
        if self.turbine_config_file.exists():
            ...
            try:
                ...
                log.error(f">> !! Failed to fetch OEDB data from {OEDB_source}: {e}")
                return
