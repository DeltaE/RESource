...
class Units(AttributesParser):
    ...
    def create_units_dictionary(self):
        ...
        try:
            ...
            utils.print_update(level=2, message=f">> Units information created and saved to '{excel_path}'")
            return units_df
        except PermissionError as e:
            utils.print_update(level=3, message=f">> Permission denied when trying to save Excel file: {e}")
