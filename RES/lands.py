...
#                 m.save(save_path)
#                 self.log.info(f">> Interactive map for '{self.region_short_code}' saved to {save_path}.")
#             else:
...
class LandContainer(ERA5Cutout,
    ...
    def set_excluder(self):
        ...
        self.log.info(f">> Loading global filters' rasters from GAEZ, trimmed to {self.region_name}")
