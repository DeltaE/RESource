...
# Import from the src layout when documentation is built without installation.
...
exclude_patterns.extend(
    [
        "notes/New_Region_Setup_Guide.md",
        "notes/aboutrasters.md",
        "notes/case_BC_full.md",
        "notes/debug_api.md",
        "notes/physics_on_suitability.md",
    ]
)
